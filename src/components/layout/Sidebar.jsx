/**
 * Sidebar Component
 * Navigation sidebar migrated from sidebar.js
 */
...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed inset-0 bg-gray-900/30 backdrop-blur-sm z-20 lg:hidden"
          onClick={onClose}
        ></div>
      )}
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
            <h1 className="text-xl font-bold text-gray-900">Bricks</h1>
            <button
              onClick={onClose}
