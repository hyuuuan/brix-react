        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-900">Duplicate Attendance Entry</h3>
            </div>
            <p className="text-gray-600 mb-4">
              An attendance record already exists for <strong>{duplicateData.employee_id}</strong> on <strong>{new Date(duplicateData.date).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</strong>.
            </p>
            <p className="text-sm text-gray-500 mb-6">
              Please check the existing records or select a different date.
            </p>
            <div className="flex justify-end space-x-3">
              <button
                onClick={() => {
